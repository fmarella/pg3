...
if ('Fattura differita vendita.registro',) not in s or s ==[]:
...
if ('Fattura pro-forma.registro',) not in s or s==[]:
...
if ('Ordine a magazzino.registro',) not in s or s==[]:
    t_settingg  = t_setting.insert()
...
if ('Carico da composizione kit.registro',) not in s or s==[]:
    t_settingg  = t_setting.insert()
...
if ('Scarico Scomposizione kit.registro',) not in s or s==[]:
    t_settingg  = t_setting.insert()
...
if ('Trasferimento merce magazzino.registro',) not in s or s==[]:
    t_settingg  = t_setting.insert()
...
if ('Ordine beni strumentali.registro',) not in s or s==[]:
    t_settingg  = t_setting.insert()
...
if ('Preventivo dettaglio.registro',) not in s or s==[]:
    t_settingg  = t_setting.insert()
...
if ('registro_preventivo_dettaglio.rotazione',) not in s or s==[]:
    t_settingg  = t_setting.insert()
